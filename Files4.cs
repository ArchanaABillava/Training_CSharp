...
namespace Training_CSharp
{
    ...
    class Serialize_Demo
    {
        ...
        public static void Main()
        {
            ...
            Stream stream = new FileStream(@"C:\TESerialize.txt", FileMode.OpenOrCreate, FileAccess.ReadWrite, FileShare.None);
            ...
            //Base(Stream-abstract class)->Derived(FileStream)
            stream = new FileStream(@"C:\TESerialize.txt", FileMode.Open, FileAccess.ReadWrite, FileShare.None);
